...
import 'volumewatchor_model.dart';
export 'volumewatchor_model.dart';

class VolumewatchorWidget extends StatefulWidget {
  const VolumewatchorWidget({super.key});

  static String routeName = 'VOLUMEWATCHOR';
  static String routePath = '/volumewatchor';

  @override
  State<VolumewatchorWidget> createState() => _VolumewatchorWidgetState();
}

class _VolumewatchorWidgetState extends State<VolumewatchorWidget> {
  late VolumewatchorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VolumewatchorModel());
